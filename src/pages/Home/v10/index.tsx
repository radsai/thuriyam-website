...
import { v10NavItems } from '@/config/v10Nav';
  ...
  return (
    <div className="relative mx-auto aspect-square max-w-md">
      <svg viewBox="0 0 100 100" className="h-full w-full drop-shadow-2xl">
        <defs>
          <linearGradient id="flywheelGradV10" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        >
          <circle cx={cx} cy={cy} r={r - 2} fill="none" stroke="url(#flywheelGradV10)" strokeWidth="0.35" strokeDasharray="1.5 2" />
        </motion.g>
        <circle cx={cx} cy={cy} r={r} fill="none" stroke="url(#flywheelGradV10)" strokeWidth="0.4" className="animate-pulse" />
        {nodes.map((n, i) => {
          ...
          <Container>
            <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              >
                ...
                {/* Punch line: cost of delay / handoff tax (Nurix-style emotional hook, operations truth) */}
                <p className="mt-5 max-w-xl border-l-2 border-cyan-500/50 pl-5 text-lg font-medium leading-snug text-zinc-200 md:text-xl md:pl-6">
                  Escalation isn’t a staffing problem—it’s the tax on handoffs between what customers see and what your systems actually do.
                </p>
                <p className="mt-6 text-lg leading-relaxed text-zinc-400 md:text-xl">
                  Most teams don’t lack automation; they lack <span className="text-zinc-300">closure</span>: who acts when something breaks, whether policy held, and what to change next. Thuriyam ties the front conversation to the systems behind it—measured end to end—so you’re not tuning from hallway stories.
                </p>
                ...
                <p className="mt-6 text-sm text-zinc-500">
                  Next: the loop—design, execute, measure, ship the next fix—with product detail where you need it.
                </p>
              </motion.div>
        ...
        <section className="border-t border-zinc-900 py-20 md:py-24">
          <Container>
            ...
            <p className="mx-auto mt-3 max-w-2xl text-center text-zinc-500">
              Illustrative deltas—where faster execution and measured feedback usually show up first. Same class of numbers we use in exec reviews, not vanity dashboards.
            </p>
