...
import { 
  ...
  Award, Trophy, Crown, Sparkle, ArrowRight,
  Wrench, DollarSign, Eye, Network, Package, BarChart3,
  Database, FileText, Users, Zap, Settings,
  ...
  return (
    <div className="min-h-screen bg-background text-foreground font-sans">
      ...
      <main>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                    {[1, 2, 3, 4].map((i) => (
                      <motion.div
                        ...
                        className="rounded-xl p-6 text-center bg-white/60 backdrop-blur-sm border border-white/20 min-h-[200px]"
                      >
                ...
                <div className="grid lg:grid-cols-3 gap-0 relative">
                  ...
                  <div className="lg:border-r border-white/50 bg-gradient-to-b from-white to-slate-50/50 p-6 relative">
                    <div className="sticky top-6">
                      <h4 className="text-sm font-semibold text-white/60 uppercase tracking-wider mb-6">Platform Capabilities</h4>
                      <div className="space-y-6">
                        {[
                          ...
                          { id: 3, label: 'Cost', icon: DollarSign, color: 'text-green-600', bgColor: 'bg-green-100', description: 'Optimize spending' },
                          { id: 4, label: 'Observability', icon: Eye, color: 'text-indigo-600', bgColor: 'bg-indigo-100', description: 'Full visibility' },
                          { id: 5, label: 'MCP Connect', icon: Network, color: 'text-orange-600', bgColor: 'bg-orange-100', description: 'Connect & integrate' },
                          { id: 6, label: 'Agent & MCP Registry', icon: Package, color: 'text-pink-600', bgColor: 'bg-pink-100', description: 'Manage & deploy' },
                          { id: 7, label: 'Reporting', icon: BarChart3, color: 'text-teal-600', bgColor: 'bg-teal-100', description: 'Insights & analytics' },
                        ].map((tab, index) => {
                      ...
                      {(() => {
                        const features = [
                          {
                            ...
                            description: 'Build production-ready AI agents without the complexity. Support for multiple channels, LLM options, and built-in testing.',
                            capabilities: [
                              'Channels: Deploy across web, API, Slack, and more',
                              'LTM & STM: Long-term and short-term memory management',
                              'Hallucination Testing: Built-in quality assurance',
                              'Multiple LLMs: Choose from frontier and open-source models',
                              'Analytics Agent: Track and optimize performance',
                              'BYO Agent: Bring your own custom agents'
                            ],
                            icon: Wrench,
                          ...
                          },
                          {
                            ...
                            capabilities: [
                              'AuthN: Robust authentication mechanisms',
                              'AuthZ: Fine-grained authorization controls',
                              'Data Access: Secure data handling and access policies',
                              'Guardrails: Built-in safety and compliance checks'
                            ],
                            icon: Shield,
                            color: 'text-red-600',
                            bgColor: 'bg-red-100',
                          ...
                          },
                          {
                            ...
                            capabilities: [
                              'Traces & Logs: Complete audit trail of all interactions',
                              'Compliance: SOC 2, GDPR, HIPAA ready',
                              'Audits: Regular compliance audits and reporting',
                              'Reporting: Detailed governance reports',
                              'Logs: Centralized logging for all operations'
                            ],
                            icon: Lock,
                            color: 'text-blue-600',
                            bgColor: 'bg-blue-100',
                          ...
                          {
                            id: 3,
                            title: 'Cost: Optimize Your AI Spending',
                            description: 'Take control of your AI costs with intelligent management and optimization tools.',
                            capabilities: [
                              'Virtual Keys: Secure, budget-controlled API access',
                              'Frontier & Open Source: Choose cost-effective models',
                              'Model Management: Optimize model selection',
                              'Avoid Key Misuse: Prevent unauthorized usage',
                              'Cost Auditing: Track and analyze spending'
                            ],
                            icon: DollarSign,
                          ...
                          },
                          {
                            ...
                            capabilities: [
                              'Agent Observability: Monitor agent performance and behavior',
                              'Guardrail Observability: Track safety and compliance metrics',
                              'Access Observability: Monitor who accesses what and when'
                            ],
                            icon: Eye,
                          ...
                          {
                            id: 5,
                            title: 'MCP Connect: Seamless Integration',
                            description: 'Connect and integrate with MCP servers and external agents effortlessly.',
                            capabilities: [
                              'Internal MCP Servers: Connect your internal services',
                              'MCP Gateway: Centralized MCP management',
                              'External MCP Servers: Integrate third-party services',
                              'External Agents: Connect with external AI agents'
                            ],
                            icon: Network,
                          ...
                          {
                            id: 6,
                            title: 'Agent & MCP Registry: Deploy with Confidence',
                            description: 'Manage, version, and deploy your agents and MCP servers like a pro.',
                            capabilities: [
                              'Docker Repository: Container-based agent management',
                              'Scalable Rollout: Deploy at scale with confidence',
                              'Complete K8s Compliant: Kubernetes-ready infrastructure'
                            ],
                            icon: Package,
                            color: 'text-pink-600',
                            bgColor: 'bg-pink-100',
                            label: 'Agent & MCP Registry',
                          },
                          {
                            id: 7,
                            title: 'Reporting: Insights That Drive Decisions',
                            description: 'Get comprehensive reports across cost, observability, and governance to make informed decisions.',
                            capabilities: [
                              'Cost Reports: Detailed spending analysis',
                              'Observability Reports: Performance and usage insights',
                              'Governance Reports: Compliance and audit summaries'
                            ],
                            icon: BarChart3,
                            color: 'text-teal-600',
                            bgColor: 'bg-teal-100',
                        ...
                        return (
                          ...
                          >
                            {/* Content */}
                            <div>
                              <h3 className="text-2xl md:text-3xl font-bold mb-4 leading-tight text-slate-900">
                                {feature.title}
                              </h3>
                            ...
                            <div className="relative rounded-xl overflow-hidden shadow-lg max-w-2xl -mt-2">
                              {(() => {
                                // Helper function to create background pattern
                                const createBackgroundPattern = (id: string, color1: string, color2: string) => (
                                  <div className="absolute inset-0 bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 rounded-xl">
                                    <svg className="absolute inset-0 w-full h-full opacity-70" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                                      <defs>
                                        <pattern id={`circles-${id}`} x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
                                          <circle cx="30" cy="30" r="2" fill="none" stroke={color1} strokeWidth="1" />
                                          <circle cx="30" cy="30" r="8" fill="none" stroke={color1} strokeWidth="0.5" />
                                        </pattern>
                                        <pattern id={`dots-${id}`} x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                                          <circle cx="20" cy="20" r="1.5" fill={color1} />
                                        </pattern>
                                        <pattern id={`arcs-${id}`} x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
                                          <path d="M 0 100 Q 50 50, 100 100 T 200 100" fill="none" stroke={color2} strokeWidth="1.5" />
                                          <path d="M 0 150 Q 50 100, 100 150 T 200 150" fill="none" stroke={color2} strokeWidth="1.5" />
                                      ...
                                      <rect width="100%" height="100%" fill={`url(#arcs-${id})`} />
                                    </svg>
                                  </div>
                                );

                                if (feature.id === 0) {
                                  // Agent Builder Demo with Background Gradient
                                  return (
                                    <div className="relative scale-75 origin-top-left">
                                      ...
                                      <div className="absolute inset-0 bg-gradient-to-br from-purple-100 via-pink-50 to-blue-100 rounded-xl">
                                        ...
                                        <svg className="absolute inset-0 w-full h-full opacity-70" xmlns="http://www.w3.org/2000/svg" preserveAspectRatio="none">
                                          <defs>
                                            <pattern id="circles-agent" x="0" y="0" width="60" height="60" patternUnits="userSpaceOnUse">
                                            ...
                                            <pattern id="dots-agent" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
                                              <circle cx="20" cy="20" r="1.5" fill="rgba(139, 92, 246, 0.4)" />
                                            </pattern>
                                            <pattern id="arcs-agent" x="0" y="0" width="200" height="200" patternUnits="userSpaceOnUse">
                                  ...
                                  return (
                              <div className="relative scale-75 origin-top-left">
                                      {createBackgroundPattern('security', 'rgba(239, 68, 68, 0.5)', 'rgba(239, 68, 68, 0.3)')}
                                  ...
                                  // Governance Demo - reuse ObservabilityDemo for now
                                  return (
                                    <div className="relative scale-75 origin-top-left">
                                      {createBackgroundPattern('governance', 'rgba(59, 130, 246, 0.5)', 'rgba(59, 130, 246, 0.3)')}
                                      <div className="relative z-10 bg-white border border-gray-200 rounded-xl overflow-hidden shadow-xl p-6">
                                        <ObservabilityDemo />
                                      </div>
                                    </div>
                                  );
                                } else if (feature.id === 3) {
                                  // Cost Demo - reuse LiteLLMDemo
                                  return (
                                    <div className="relative scale-75 origin-top-left">
                                      {createBackgroundPattern('cost', 'rgba(34, 197, 94, 0.5)', 'rgba(34, 197, 94, 0.3)')}
                                <div className="relative z-10">
                                  <LiteLLMDemo />
                                </div>
                              </div>
                              ...
                              // Observability Demo
                                  return (
                              <div className="relative scale-75 origin-top-left">
                                      {createBackgroundPattern('observability', 'rgba(99, 102, 241, 0.5)', 'rgba(99, 102, 241, 0.3)')}
                                <div className="relative z-10">
                                  <ObservabilityDemo />
                                </div>
                              </div>
                                  ...
                                  // Placeholder for MCP Connect, Registry, and Reporting
                                  return (
                              <div className="relative scale-75 origin-top-left">
                                      {createBackgroundPattern(`demo-${feature.id}`, 'rgba(139, 92, 246, 0.5)', 'rgba(139, 92, 246, 0.3)')}
                                      <div className="relative z-10 bg-white border border-gray-200 rounded-xl overflow-hidden shadow-xl p-8 min-h-[400px] flex items-center justify-center">
                                        <div className="text-center">
                                          {React.createElement(feature.icon, { className: `w-16 h-16 mx-auto mb-4 ${feature.color}` })}
                                          <p className="text-gray-600 text-lg">Interactive demo coming soon</p>
                                          <p className="text-gray-400 text-sm mt-2">Explore capabilities in the left panel</p>
                                </div>
                                </div>
                              </div>
                                  );
        ...
        <Section className="bg-gradient-to-b from-slate-50 via-slate-100 to-slate-50 pt-16 pb-12">
          <Container>
            <div className="max-w-7xl mx-auto">
